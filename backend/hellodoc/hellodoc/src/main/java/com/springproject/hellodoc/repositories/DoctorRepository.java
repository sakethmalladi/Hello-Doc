...
public interface DoctorRepository extends JpaRepository<Doctor, Long> {
    ...
    @Query("SELECT d FROM Doctor d WHERE " +
           ...
           "(:specialization IS NULL OR d.specialization LIKE CONCAT('%', :specialization, '%'))")
    ...
    @Query(value = "SELECT * FROM doctor d " +
                   ...
                   "AND (:specialization IS NULL OR d.specialization LIKE CONCAT('%', :specialization, '%'))", nativeQuery = true)
